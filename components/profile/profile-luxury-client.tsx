    ...
    <div className="relative min-h-screen bg-[var(--background)] pb-32 pt-0">
      <section className="relative min-h-[min(92svh,900px)] overflow-hidden">
        ...
        <div className="container-shell relative z-10 flex min-h-[min(92svh,900px)] flex-col items-center justify-end pb-16 pt-28 text-center md:pb-20 md:pt-32">
          ...
          <motion.div style={{ opacity: panelOpacity }} className="mx-auto flex max-w-4xl flex-col items-center">
            ...
            <h1 className="headline-display mt-7 text-[clamp(2.8rem,7vw,5.8rem)] font-semibold leading-[0.96] tracking-[-0.03em] text-white drop-shadow-[0_8px_48px_rgba(0,0,0,0.65)]">
              {profile.name}
            </h1>
          ...
          >
            ...
            <div className="mt-6 flex flex-col gap-2.5">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex min-h-[46px] w-full items-center justify-center gap-2 rounded-full bg-[#25d366] text-sm font-semibold text-[#04120a] transition hover:brightness-110"
              >
                <Send className="h-4 w-4" />
                WhatsApp
              </a>
        ...
        <div className="container-shell flex items-center justify-between gap-3">
          ...
          <div className="grid flex-1 grid-cols-3 gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex min-h-[44px] items-center justify-center rounded-full bg-[#25d366] px-2 text-sm font-semibold text-[#04120a]"
            >
              WA
            </a>
