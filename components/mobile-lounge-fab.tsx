...
export function MobileLoungeFab() {
  return (
    <div className="pointer-events-none fixed bottom-0 left-0 right-0 z-[60] flex justify-center px-0 pt-2 md:hidden">
      <div className="pointer-events-auto w-full max-w-lg border-t border-gray-200 bg-white/95 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 shadow-[0_-8px_32px_rgba(15,23,42,0.08)] backdrop-blur-md">
        <Link
          href="/hyderabad"
